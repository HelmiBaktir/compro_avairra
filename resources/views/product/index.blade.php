...
<!-- content -->
@section('content')
<!-- modal Add MASIHHH BELUM BISAAAAA-->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="border-radius: 17px;">
            <div class="modal-header" style="background-color: #e61919; border-radius:17px 17px 0px 0px;">
                <h4 style="color:white;">Tambah Data Product</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                <form method="POST" id="regForm" action="{{ route('product.store') }}" aria-label="{{ __('Register') }}">
                    <!-- @csrf -->
                    <div class="form-group row">
                        <label class="col-md-4 col-form-label">{{ __('NOMOR PRODUCT') }}</label>
                        <input id="nomor_product" type="text" class="form-control" name="nomor_product" required autofocus>                        
                    </div>
                    <div class="form-group row">
                        <label class="col-md-4 col-form-label">{{ __('SERIES PRODUCT') }}</label>
                        <input id="series_product" type="text" class="form-control" name="series_product" required autofocus>                        
                    </div>

                    <div class="form-group row">
                        <label class="col-md-4 col-form-label">{{ __('PRODUCT NAME') }}</label>
                        <input id="name_product" type="text" class="form-control" name="name_product"  required autofocus>                        
                    </div>

                    <div class="form-group row">
                        <label class="col-md-4 col-form-label">{{ __('DESCRIPTION') }}</label>
                        <textarea id="desc" type="text" class="form-control" name="desc" row='5'  required autofocus></textarea>                     
                    </div>

                    <div class="form-group row">
                        <label class="col-md-4 col-form-label">{{ __('IMAGE PRODUCT') }}</label>
                        <input id="image_path" type="text" class="form-control" name="image_path"  required autofocus>                       
                    </div>

                    <div class="form-group row">
                        <label class="col-md-4 col-form-label">{{ __('CATEGORY PRODUCT') }}</label>
...
<!-- modal Edit BELUMMM DI KERJAKAANNN-->
...
<!-- modal Delete BELUMMM DI KERJAKAANNN-->
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-3 col-4" title="Tambah">
                            <a  class="btn btn-block btn-primary btn-sm" href="{{ route('product.create') }}"><i class="fa fa-plus-circle nav-icon"></i> Tambah Product Baru</a>
                        </div>
                                ...
                                <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php } ?>
                                            <td>{{$value->nomor_product}}</td>
                                            <td>{{$value->series_product}}</td>
