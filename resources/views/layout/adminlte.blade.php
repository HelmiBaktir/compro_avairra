...
<head>
  ...
  <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('easton/images/logo.png')}}">
  <title>Master Avairra</title>
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="{{url('/')}}" class="brand-link">
        <img src="{{asset('easton/images/logo.png')}}" alt="Avairra Logo" class="brand-image img-circle elevation-3"
          style="opacity: .8">
