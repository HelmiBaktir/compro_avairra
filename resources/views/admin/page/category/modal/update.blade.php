                    ...
                    <div class="fv-row">
                        <div class="d-flex align-content-between flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
                            <div class="text-start d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3 py-lg-0">
                                <h3 class="modal-title pt-2">Update Category</h3>
                            </div>
                            <div>
    ...
    $('#btn-simpan').click(function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let act = "{{ route('categories.update',':id') }}".replace(':id','{{ encrypt($category->id) }}')
                let form_data = new FormData(document.querySelector("#update_category_form"));
